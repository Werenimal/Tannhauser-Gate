...
/mob/living/basic/pet/redpanda/Initialize(mapload)
	. = ..()
	AddElement(/datum/element/pet_bonus, "WAHS! Uncontrollably!")
	AddElement(/datum/element/footstep, footstep_type = FOOTSTEP_MOB_CLAW)

/mob/living/basic/pet/redpanda/zesty
	name = "Zesty"
...
/datum/supply_pack/critter/redpanda
	...
	contains = list(/mob/living/basic/pet/redpanda)
	crate_name = "red panda crate"

/datum/supply_pack/critter/redpanda/generate()
	. = ..()
	if(prob(3))
		var/mob/living/basic/pet/redpanda/D = locate() in .
		qdel(D)
		new /mob/living/basic/pet/redpanda/zesty(.)
